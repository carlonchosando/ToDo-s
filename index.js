...
// Tu código acá:
var title = document.querySelector("#createdBy");
title.innerHTML = title.innerHTML + " Carlos";
...
function buildToDo(todo, index) {
  // Tu código acá:
  //    1) Crear un elemento 'div' y asignárselo a una variable denominada 'toDoShell'
  var toDoShell = document.createElement('div');//creo variable 'toDoShell'con un 'div' element
  //    2) Asignarle a 'toDoShell' la clase 'toDoShell'
  toDoShell.className = 'toDoShell';// creeo una clase 'toDoShell'
  //3) Crear un elemento 'span' y asignárselo a una variable denominada 'toDoText'
...
function buildToDos(toDos) {
  // Tu código acá:
  var arreglo = toDos.map((todo , index) => buildToDo(todo, index)); 
  var arreglo = toDos.map(buildToDo)
  return arreglo;
}
